package org.ticketmaster.application;

import org.ticketmaster.event.ReprEvent;
import org.ticketmaster.exception.TickMastExceptionFilter;
import org.ticketmaster.exception.TickMastExceptionParser;
import org.ticketmaster.exception.TickMastExceptionService;
import org.ticketmaster.parser.ReprEventParser;
import org.ticketmaster.filter.ReprEventFilter;
...
public class TickMastService
{
    ...
    public void checkDataArgs(HashMap<String, String> param) throws TickMastExceptionService {
        ...
        if (verify != param.size()) {
            ...
            throw new TickMastExceptionService("TickMastService::checkDataArgs -- " + param.toString());
        }
    }

    public void checkStatArgs(HashMap<String, String> param) throws TickMastExceptionService {
        ...
        if (verify != param.size()) {
            System.out.printf("TickMastService::checkStatArgs -- " + param.toString() + " \n");
            throw new TickMastExceptionService("TickMastService::checkStatArgs -- " + param.toString());
        }
    }

    public String searchData(HashMap<String, String> args) throws IOException, TickMastExceptionService, TickMastExceptionParser, TickMastExceptionFilter {
        ...
        if (msCountry == null)
        {
            ...
            throw new TickMastExceptionService("TickMastService::searchData -- countrycode NOT PRESENT \n");
        }
        if (!masCountriesEu.contains(msCountry))
        {
            System.out.printf("TickMastService::searchData -- countrycode NOT VALID -- %s \n", msCountry);
            throw new TickMastExceptionService("TickMastService::searchData -- countrycode NOT VALID -- " + msCountry + " \n");
        }
        ...
        try {
            ...
            throw new TickMastExceptionService("TickMastService::searchData -- parse exception");
        }

        if (oJsonRoot == null)
        {
            System.out.printf("TickMastService::searchData -- JSON object EMPTY \n");
            throw new TickMastExceptionService("TickMastService::searchData -- JSON object EMPTY");
        }
    ...
    public String searchStat(HashMap<String, String> args) throws IOException, TickMastExceptionService, TickMastExceptionParser, TickMastExceptionFilter {
        System.out.printf("**** TickMastService::searchStat -- %s \n", args.toString());
        msCountry = args.get("countrycode");
        if (msCountry == null)
        {
            System.out.printf("TickMastService::searchStat -- countrycode NOT PRESENT \n");
            throw new TickMastExceptionService("TickMastService::searchStat -- countrycode NOT PRESENT");
        }
        if (!masCountriesEu.contains(msCountry))
        {
            System.out.printf("TickMastService::searchData -- countrycode NOT VALID -- %s \n", msCountry);
