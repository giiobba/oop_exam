package org.ticketmaster.parser;
...
public class ReprEventParser {
    ...
    public void JsonToEventParse(JSONObject oJsonRoot) throws TickMastExceptionParser
    {
        ...
        if (oJsonEmbedded == null) {
            ...
            throw new TickMastExceptionParser("ReprEventParser::JsonToEventParse -- _embedded NOT FOUND \n");
        }
        ...
        if (aoJsonEvents == null) {
            ...
            throw new TickMastExceptionParser("ReprEventParser::JsonToEventParse -- events NOT FOUND \n");
        }
